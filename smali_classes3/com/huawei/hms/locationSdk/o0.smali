...
.method public a(Lcom/huawei/hms/locationSdk/s;Lcom/huawei/hms/common/internal/ResponseErrorCode;Ljava/lang/String;Lsy/h;)V
    ...
    invoke-direct {v5, p3}, Lo70/b;-><init>(Ljava/lang/String;)V

    invoke-virtual {v5, v2}, Lo70/b;->has(Ljava/lang/String;)Z

    move-result p3

    if-eqz p3, :cond_3

    invoke-virtual {v5, v2}, Lo70/b;->getJSONObject(Ljava/lang/String;)Lo70/b;
    ...
    :goto_0
    invoke-virtual {p3, v1}, Lo70/b;->has(Ljava/lang/String;)Z

    move-result v7

    if-eqz v7, :cond_1

    invoke-virtual {p3, v1}, Lo70/b;->getInt(Ljava/lang/String;)I
    ...
    :goto_1
    invoke-virtual {p3, v0}, Lo70/b;->has(Ljava/lang/String;)Z

    move-result v7

    if-eqz v7, :cond_2

    invoke-virtual {p3, v0}, Lo70/b;->getString(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v5, p1}, Lo70/b;->getJSONObject(Ljava/lang/String;)Lo70/b;
    ...
    invoke-virtual {p3, p4, p2, p1}, Lcom/huawei/hms/support/api/location/common/exception/ServiceErrorCodeAdaptor;->setTaskByServiceErrorCode(Lsy/h;Lcom/huawei/hms/common/internal/ResponseErrorCode;Ljava/lang/Object;)V
...
.method public bridge synthetic doExecute(Lcom/huawei/hms/common/internal/AnyClient;Lcom/huawei/hms/common/internal/ResponseErrorCode;Ljava/lang/String;Lsy/h;)V
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/huawei/hms/locationSdk/o0;->a(Lcom/huawei/hms/locationSdk/s;Lcom/huawei/hms/common/internal/ResponseErrorCode;Ljava/lang/String;Lsy/h;)V
