...
# virtual methods
.method public a(Lcom/huawei/hms/location/GetFromLocationNameRequest;)Lsy/g;
    .locals 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v2, v4, v5, v6}, Lcom/huawei/hms/support/api/entity/location/geocoder/GeocoderRequest;-><init>(Landroid/content/Context;Ljava/lang/String;I)V

    invoke-virtual {p1}, Lcom/huawei/hms/location/GetFromLocationNameRequest;->getLowerLeftLatitude()D

    move-result-wide v4

    invoke-virtual {v2, v4, v5}, Lcom/huawei/hms/support/api/entity/location/geocoder/GeocoderRequest;->setLowerLeftLatitude(D)V

    invoke-virtual {p1}, Lcom/huawei/hms/location/GetFromLocationNameRequest;->getLowerLeftLongitude()D

    move-result-wide v4

    invoke-virtual {v2, v4, v5}, Lcom/huawei/hms/support/api/entity/location/geocoder/GeocoderRequest;->setLowerLeftLongitude(D)V

    invoke-virtual {p1}, Lcom/huawei/hms/location/GetFromLocationNameRequest;->getUpperRightLatitude()D

    move-result-wide v4

    invoke-virtual {v2, v4, v5}, Lcom/huawei/hms/support/api/entity/location/geocoder/GeocoderRequest;->setUpperRightLatitude(D)V

    invoke-virtual {p1}, Lcom/huawei/hms/location/GetFromLocationNameRequest;->getUpperRightLongitude()D

    move-result-wide v4

    invoke-virtual {v2, v4, v5}, Lcom/huawei/hms/support/api/entity/location/geocoder/GeocoderRequest;->setUpperRightLongitude(D)V
    ...
    :try_start_0
    const-string v4, "getFromLocationName begin. Version Code = 61100301"

    invoke-static {v3, p1, v4}, Lcom/huawei/hms/support/api/location/common/HMSLocationLog;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v7, "location.getFromLocationName"
    ...
    invoke-direct/range {v5 .. v10}, Lcom/huawei/hms/locationSdk/r0;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, v4}, Lcom/huawei/hms/locationSdk/n;->doWrite(Lcom/huawei/hms/common/internal/TaskApiCall;)Lsy/g;
    ...
    invoke-static {v3, p1, v2}, Lcom/huawei/hms/support/api/location/common/HMSLocationLog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public a(Lcom/huawei/hms/location/GetFromLocationRequest;)Lsy/g;
    .locals 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct/range {v4 .. v10}, Lcom/huawei/hms/support/api/entity/location/geocoder/GeocoderRequest;-><init>(Landroid/content/Context;DDI)V
    ...
    :try_start_0
    const-string v4, "getFromLocation begin. Version Code = 61100301"
    ...
    const-string v7, "location.getFromLocation"
    ...
    invoke-direct/range {v5 .. v10}, Lcom/huawei/hms/locationSdk/s0;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
